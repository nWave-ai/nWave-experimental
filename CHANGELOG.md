...
- Update changelog v1.1.13 — deliver Phase 3 /nw:refactor fix
  ([`9624b24`](https://github.com/nWave-ai/nwave-dev/commit/9624b24732c0ebda36755a694d5ab9d318902fe4))
...
- Fix changelog version to match release (v1.1.9)
  ([`7cde93e`](https://github.com/nWave-ai/nwave-dev/commit/7cde93eb101a3f6f8c016dcfcdb71655d2813d8d))
...
- Align changelog to production version numbering
  ([`b2b34f6`](https://github.com/nWave-ai/nwave-dev/commit/b2b34f6e29f255baec3babc5d20265d8d4c5e1cd))
...
- Clarify WSL requirement and add Windows pipx troubleshooting
  ([`2c63630`](https://github.com/nWave-ai/nwave-dev/commit/2c63630ccc98bf87cf5cbbb193db5e7475401e59))
...
- Add installation link in quick start, reorder getting started
  ([`d802377`](https://github.com/nWave-ai/nwave-dev/commit/d80237797310d29952da6190d5e7675db4016509))

- Add pipx prerequisite instructions and troubleshooting
  ([`608d628`](https://github.com/nWave-ai/nwave-dev/commit/608d628af506b58d200374331209b16b89ab9994))

- Clarify where to run install vs use commands
  ([`73d6954`](https://github.com/nWave-ai/nwave-dev/commit/73d6954e2a9c27042adaa1db339cdbb1b34818a8))
...
- Standardize DEVOP → DEVOPS wave name across production docs
  ([`1f345c6`](https://github.com/nWave-ai/nwave-dev/commit/1f345c68375f901217fbc2a097a1b3a2306b2e62))
...
- Add tutorial for building first feature with nWave
  ([`acd2563`](https://github.com/nWave-ai/nwave-dev/commit/acd2563b90df145c27c29b54265f1642e6f8b0d3))

- Fix stale paths, branding, and strip aspirational content from reference docs
  ([`b11f151`](https://github.com/nWave-ai/nwave-dev/commit/b11f151cc306453cad60d15ad43c1df97b3e30e9))

- Rewrite plugin reference and troubleshooting guide for clarity
  ([`33b0bd6`](https://github.com/nWave-ai/nwave-dev/commit/33b0bd64d2d13b8e10c2012370340962ae9d0954))

- Rewrite README for progressive disclosure, extract CONTRIBUTING.md
  ([`0d0dc21`](https://github.com/nWave-ai/nwave-dev/commit/0d0dc21fb1c7ae40e6f5c8f32ee17f56720109a8))
...
- Fix installation guide to match actual installed file layout
  ([`a100f86`](https://github.com/nWave-ai/nwave-dev/commit/a100f8628b907fad54b82f6f449bb39d689e4bdd))

- Fix remaining inconsistencies across guides and reference
  ([`9864f66`](https://github.com/nWave-ai/nwave-dev/commit/9864f662007214d14e72ecee699d4c77ab065f2d))

- Fix stale agent names and paths across guides and reference docs
  ([`5799087`](https://github.com/nWave-ai/nwave-dev/commit/579908712e64e053d5ea319f42d5f9a14bc49b1b))

- Remove aspirational 5-layer testing docs and outdated template (-2371 LOC)
  ([`0b94343`](https://github.com/nWave-ai/nwave-dev/commit/0b94343eb1623ddfbe1cc32d98ed773a4088c8ee))

- Rename 5-Layer Testing to Quality Excellence in README
  ([`61ecfc2`](https://github.com/nWave-ai/nwave-dev/commit/61ecfc297060514ce229aab8304bde9aa79ed442))
...
- Enforce canonical 6-wave sequence, remove /nw:roadmap from public docs
  ([`d8b9f48`](https://github.com/nWave-ai/nwave-dev/commit/d8b9f484c82501ae6266a1ff29c6b91ee9d9281f))

- Explain wave metaphor and manual vs automated deliver workflow
  ([`2e77596`](https://github.com/nWave-ai/nwave-dev/commit/2e77596c24e451d6d29d8c943b68692fccd241c0))

- Replace step file references with task descriptions in examples
  ([`7bdf5a0`](https://github.com/nWave-ai/nwave-dev/commit/7bdf5a04903c8eb108e1ec77ae4fdd3cc09f6430))
...
- Fix broken links, orphan docs, and DIVIO misplacements
  ([`cb89b5d`](https://github.com/nWave-ai/nwave-dev/commit/cb89b5d8c2501814ff80b29fa4ae1970108efd0d))

- Remove stale commands and fix agent names across all public docs
  ([`822fbf9`](https://github.com/nWave-ai/nwave-dev/commit/822fbf9a793d8b2087d2b42fd3b9465236a73921))
...
- Update authors in pyproject.toml and public release pipeline
  ([`ac75c60`](https://github.com/nWave-ai/nwave-dev/commit/ac75c60975b69af3b4f27907d4ef19d96dac1ccb))

### Documentation

- Improve 10 public reference docs, fix broken links, link in README
  ([`a2a4c5a`](https://github.com/nWave-ai/nwave-dev/commit/a2a4c5a1ac12d881f92780787396a408cf8b48d1))

- Rewrite README, installation guide, and public README for v1.1.0
  ([`e27facb`](https://github.com/nWave-ai/nwave-dev/commit/e27facb03a44431c69a3e1acbd7a1681583bc875))
...
- Remove dead weight from nWave/ (-27.7K LOC)
  ([`4ef0724`](https://github.com/nWave-ai/nwave-dev/commit/4ef07240da8eb1dc515837eefae8be9bb437144b))

- Remove unused nWave/checklists/ directory
  ([`a06008c`](https://github.com/nWave-ai/nwave-dev/commit/a06008cf4bc6949a7e91c10590257f6e37410296))

### Documentation

- Update the documentation for support and contributing so that it references Discord
  ([`5d422c8`](https://github.com/nWave-ai/nwave-dev/commit/5d422c82456673d0be3d72d3ab9053322cf856cf))
...
- **installer**: Reformat skills verification output to multi-line with emojis
  ([`559ad3f`](https://github.com/nWave-ai/nwave-dev/commit/559ad3f122f736b8a67850b3496931dec2484934))

- **installer**: Split DES config values into indented multi-line output
  ([`9a7c055`](https://github.com/nWave-ai/nwave-dev/commit/9a7c05587af8a8c610fac115dff6ef63ec1e0eb3))
...
- Clean up project structure and consolidate docs (28 → 8 dirs)
  ([`bf5cc75`](https://github.com/nWave-ai/nwave-dev/commit/bf5cc75ed3cdc0dd64913dbeb93d76fc17bd3599))

- Remove abandoned feature docs and update active execution logs
  ([`96759e9`](https://github.com/nWave-ai/nwave-dev/commit/96759e95e2c9769a3d986fdbe3bec81d83bd1112))

- Remove dead scripts and update scripts/ README
  ([`219fc1e`](https://github.com/nWave-ai/nwave-dev/commit/219fc1ea118ea5bc97a422b50b4303f4cecead0d))

- Update repo references from 11PJ11/crafter-ai to nWave-ai/nwave-dev
  ([`6f288ab`](https://github.com/nWave-ai/nwave-dev/commit/6f288ab24692a84d8152bdf1c46a0725219ab1ef))

- **tests**: Remove 30 fully-skipped legacy DES tests
  ([`fe341e5`](https://github.com/nWave-ai/nwave-dev/commit/fe341e536c7f3038f002512107e524fd8edc8868))

### Documentation

- Document roadmap init CLI in command file
  ([`7f83329`](https://github.com/nWave-ai/nwave-dev/commit/7f8332912e6e45530c446f842e725a09373d2931))

- **build-pipeline-elimination**: Finalize feature with evolution archive
  ([`ec785df`](https://github.com/nWave-ai/nwave-dev/commit/ec785dfbc905dc40744a87f5f2948443322927b1))

- **des**: Finalize des-observability feature with evolution archive
  ([`5309cb6`](https://github.com/nWave-ai/nwave-dev/commit/5309cb6c58b24dac66b0fe08a06421b261690fa8))
...
- **release**: Bump nwave public_version to 1.0.4
  ([`53f992c`](https://github.com/nWave-ai/nwave-dev/commit/53f992c25deb6db6a10e4a8f76f72af515e94665))

- **release**: V2.13.3
  ([`314d116`](https://github.com/nWave-ai/nwave-dev/commit/314d1169323baa76453f2496e0c59ba6c164d692))
...
- **release**: V2.13.2
  ([`311c79d`](https://github.com/nWave-ai/nwave-dev/commit/311c79da4cbed1f35558a07fd05129a56ab39ede))
...
- **release**: V2.13.1
  ([`15cd658`](https://github.com/nWave-ai/nwave-dev/commit/15cd65845a677a6c69a3537c33d588e5a9d99129))
...
- **release**: Bump nwave public_version to 1.0.1
  ([`ea72796`](https://github.com/nWave-ai/nwave-dev/commit/ea7279618ad1ee9a2ee3ff7c8cbb6afca428838c))

- **release**: Bump nwave public_version to 1.0.2
  ([`6225595`](https://github.com/nWave-ai/nwave-dev/commit/6225595ad92281a230193725e682f4b503d55527))

- **release**: V2.13.0
  ([`ccba2cf`](https://github.com/nWave-ai/nwave-dev/commit/ccba2cf55ee0f2bffc29764470962ef0186c7603))
...
- **release**: V2.12.1
  ([`e70a190`](https://github.com/nWave-ai/nwave-dev/commit/e70a190720ffc505b069e836fc06df0a8101d521))
...
- **release**: V2.12.0
  ([`baf2fa5`](https://github.com/nWave-ai/nwave-dev/commit/baf2fa53c22b9c101a7aec77e1826c837d4b5f53))

### Documentation

- **des**: Add observability plan, root-cause analysis, and execution logs
  ([`f492342`](https://github.com/nWave-ai/nwave-dev/commit/f492342d3001fa4bafba9ea7daa41504794f03bf))
...
- **release**: V2.11.4
  ([`3bd2a1f`](https://github.com/nWave-ai/nwave-dev/commit/3bd2a1fcf76384dd5bae6a7e05ddb15269c31d73))
...
- **release**: V2.11.3
  ([`3617151`](https://github.com/nWave-ai/nwave-dev/commit/3617151ac785772612fc0503d0acb31ca7e054e5))
...
- **release**: V2.11.2
  ([`07f00cd`](https://github.com/nWave-ai/nwave-dev/commit/07f00cdd92ac2f3fb79db02ae2dc396f27d76f86))
...
- **release**: V2.11.1
  ([`7f6b3cc`](https://github.com/nWave-ai/nwave-dev/commit/7f6b3ccae835e6488bf11613303fa19254d371a2))
...
- **release**: V2.11.0
  ([`b4c716b`](https://github.com/nWave-ai/nwave-dev/commit/b4c716b78b07edd37f5d51fc4ed8a60806603068))
...
- **release**: V2.10.3
  ([`58b4c4c`](https://github.com/nWave-ai/nwave-dev/commit/58b4c4c946c703df511460d89dc287e7e0f7c2cf))
...
- **release**: V2.10.2
  ([`ed6179c`](https://github.com/nWave-ai/nwave-dev/commit/ed6179c73ed28f9cd9c1c7909a431639e80ab80b))
...
- **release**: V2.10.1
  ([`e91d7c1`](https://github.com/nWave-ai/nwave-dev/commit/e91d7c136b87a0545d9fa766504e112b96ed3ccc))
...
- **release**: V2.10.0
  ([`19311a3`](https://github.com/nWave-ai/nwave-dev/commit/19311a3ab65978b4c6cc97c048484cde22b01bea))

### Documentation

- **ci**: Add PyPI publishing job to workflow README
  ([`2e7ec2b`](https://github.com/nWave-ai/nwave-dev/commit/2e7ec2bb6ace907a6e600a89e45d652cecdc078e))

- **ci**: Update workflow README for split CI/Release architecture
  ([`01ee4ba`](https://github.com/nWave-ai/nwave-dev/commit/01ee4ba47f30ae71f9489961a24647425e0aaa62))
...
- **release**: V2.9.0
  ([`665d9c3`](https://github.com/nWave-ai/nwave-dev/commit/665d9c315f089cd579c173380366a3cdfe85ce9b))
...
- **release**: V2.8.0
  ([`ebb2b9e`](https://github.com/nWave-ai/nwave-dev/commit/ebb2b9e28d5185a9d0a3e771360bd29cd96002ab))

### Code Style

- Fix trailing whitespace in audit log adapters
  ([`8dc1ea8`](https://github.com/nWave-ai/nwave-dev/commit/8dc1ea872cd716e83bc68b3b34e75c14453ade50))

### Documentation

- **commands**: Mark /nw:mikado as experimental
  ([`ff3600a`](https://github.com/nWave-ai/nwave-dev/commit/ff3600ae503300084679c9244d5ea2bd51ff33b4))
...
- **release**: V2.7.0
  ([`861e5b3`](https://github.com/nWave-ai/nwave-dev/commit/861e5b3e710046a0d5e2bc065a0c0c6f3581dcce))
...
- **release**: V2.6.0
  ([`9ed2998`](https://github.com/nWave-ai/nwave-dev/commit/9ed2998c49fb146b147908233a7a91d38d23c5ea))
...
- **release**: V2.5.1
  ([`f9a1434`](https://github.com/nWave-ai/nwave-dev/commit/f9a1434a8023764bdf7a188708f37b7fb881c4e6))
...
- **release**: V2.5.0
  ([`b5bec43`](https://github.com/nWave-ai/nwave-dev/commit/b5bec431489eb384c27edff6ecc0c363a8e758db))
...
- **release**: V2.4.0
  ([`8d1cc9f`](https://github.com/nWave-ai/nwave-dev/commit/8d1cc9f112f1c7d446b6d125df6dba9ba6daad1d))
...
- **release**: V2.3.1
  ([`a883e7d`](https://github.com/nWave-ai/nwave-dev/commit/a883e7d5bb3c8a0b3d293aa9d936aed4af6015bb))
...
- **release**: V2.3.0
  ([`0ca7cf7`](https://github.com/nWave-ai/nwave-dev/commit/0ca7cf71bd95964fb3b103367f77046f7361b43e))
...
- Fix ruff format in test_execute_template_sync
  ([`b3c64ba`](https://github.com/nWave-ai/nwave-dev/commit/b3c64bab1fa3800d23ed173c4d24245900ea21db))
...
- **audit-log-refactor**: Verify step 04-01 migration complete
  ([`47d82ce`](https://github.com/nWave-ai/nwave-dev/commit/47d82ce6157bfc130bf7eadc6c45ab19f6ca32bc))

- **release**: V2.1.0
  ([`54e8341`](https://github.com/nWave-ai/nwave-dev/commit/54e83410516c8c239924e8e35631e66798f419f2))

### Code Style

- Fix trailing whitespace and formatting in hook enforcement steps
  ([`4c4ffd0`](https://github.com/nWave-ai/nwave-dev/commit/4c4ffd09682d080afbd3b3fec6d6fd22f446c0b9))

- **des**: Apply ruff format to 4 unformatted files
  ([`a5fd876`](https://github.com/nWave-ai/nwave-dev/commit/a5fd876c4e1a4b5f8401ca7b91d94dc35e351f75))

### Documentation

- **audit-log**: Update audit trail docs to feature_name/step_id schema - step 06-01
  ([`79b9788`](https://github.com/nWave-ai/nwave-dev/commit/79b9788b2419609331843c0849e7d396809d7a8a))

- **audit-log**: Update template and create evolution document - step 06-02
  ([`073be3b`](https://github.com/nWave-ai/nwave-dev/commit/073be3b1646710e582990c7e7d625bd7d8853518))

- **audit-log-refactor**: Finalize feature - archive, cleanup, reference docs
  ([`cdfb35c`](https://github.com/nWave-ai/nwave-dev/commit/cdfb35c4020568d358a904e3a8ac1ce93ca38eec))

- **audit-log-refactor**: Step 04-02 verification complete
  ([`691605e`](https://github.com/nWave-ai/nwave-dev/commit/691605e4be5653104084308ae9dfea8eedd686ab))
...
- **audit-log**: Migrate legacy audit logger tests to hexagonal structure - step 04-01
  ([`7d82729`](https://github.com/nWave-ai/nwave-dev/commit/7d8272956692edfc35b5d5997885b0fbae7a2461))
...
- **release**: V2.0.4
  ([`e4f4c1e`](https://github.com/nWave-ai/nwave-dev/commit/e4f4c1e50d602f67997474f207e6cb387e152124))
...
- **release**: V2.0.3
  ([`b63c627`](https://github.com/nWave-ai/nwave-dev/commit/b63c627625311fbf6fcdccb1a89fc6610f93f68e))

### Continuous Integration

- Trigger pipeline after commit message contained skip-ci literal
  ([`b018438`](https://github.com/nWave-ai/nwave-dev/commit/b0184386a7a1457c62022affe6f82907268077cc))
...
- **release**: V2.0.2
  ([`daae973`](https://github.com/nWave-ai/nwave-dev/commit/daae973de5b230d85fbe4031c8a4adca17295201))
...
- **release**: V2.0.1
  ([`453ff7a`](https://github.com/nWave-ai/nwave-dev/commit/453ff7a9bcaf3fcff85a3969fdb534d80bed33af))
...
- Integrate TemplateProcessor into CommandProcessor build pipeline
  ([`df10ae7`](https://github.com/nWave-ai/nwave-dev/commit/df10ae79c11c0c3a40096d4c296ee82d9709a8a4))

### Chores

- Add .des/ to gitignore
  ([`36c61ec`](https://github.com/nWave-ai/nwave-dev/commit/36c61ec678639bb79d22b5d06702ab8f57a4366c))

- Add .nwave-audit.log to gitignore
  ([`0ec5622`](https://github.com/nWave-ai/nwave-dev/commit/0ec5622758a13b1ec336a0175e20950bd6e2aff2))

- Add pytest.log to gitignore
  ([`8959c56`](https://github.com/nWave-ai/nwave-dev/commit/8959c563b5e38d9a7aaad2dc4af47e57f8469f25))

- Fix trailing whitespace and EOF in visual stdout files
  ([`3c1f603`](https://github.com/nWave-ai/nwave-dev/commit/3c1f603146d8bebd343c4eb121c98c16ecca50ad))

- Remove obsolete Schema v1.x hook installer
  ([`7d67b29`](https://github.com/nWave-ai/nwave-dev/commit/7d67b292a4da23d3367b6aef6f525cb94be4a51b))

- Remove workflow artifacts after finalization
  ([`d02086e`](https://github.com/nWave-ai/nwave-dev/commit/d02086e76fadc4f853802050b46bcc64ef6cc1b9))

- Reorganize feature planning to docs/feature and clean Phase 3 steps
  ([`6f78e5d`](https://github.com/nWave-ai/nwave-dev/commit/6f78e5de05ccf7aa9f399c436c0590ada530ad51))

- Trigger ci after force push
  ([`3a562f8`](https://github.com/nWave-ai/nwave-dev/commit/3a562f8d14b5244eeabfcc73f171511245f66b31))

- Update execution-status.yaml with commit hash 8ad0115 for step 02-02
  ([`789c8ab`](https://github.com/nWave-ai/nwave-dev/commit/789c8ab9ae6906bdab5de644636241fa25a706c2))

- Update execution-status.yaml with commit hash c962023 for step 03-01
  ([`0eb41b8`](https://github.com/nWave-ai/nwave-dev/commit/0eb41b83e517c45f9ad0f8c09516c1de30adf2fe))

- **01-01**: Complete commit phase with files tracking
  ([`7fc039f`](https://github.com/nWave-ai/nwave-dev/commit/7fc039fdd6ae3663fa04c5be522c4add06011d24))

- **01-01**: Review phase approved
  ([`6cb0623`](https://github.com/nWave-ai/nwave-dev/commit/6cb0623c6680e016e756c34e0189107324846b7f))

- **01-02**: Complete step execution status
  ([`e498748`](https://github.com/nWave-ai/nwave-dev/commit/e498748bd938f81594fccedc7f0d7b600f3b62c5))

- **01-02**: Inline quality review approved
  ([`70c32e7`](https://github.com/nWave-ai/nwave-dev/commit/70c32e798893538bccac58e38ceec5ba98c3c31b))

- **02-01**: Update execution status with step completion
  ([`2aa7c9b`](https://github.com/nWave-ai/nwave-dev/commit/2aa7c9b5d6449ef79c0388f04fcc60e0a98a5faf))

- **audit**: Remove legacy .nwave-audit.log file
  ([`5ac0940`](https://github.com/nWave-ai/nwave-dev/commit/5ac0940ce673a82e0659af5a265ab1c20567eee0))

- **audit**: Update audit log for step 03-04 orchestrator integration completion
  ([`48d7f9e`](https://github.com/nWave-ai/nwave-dev/commit/48d7f9ec43685e7a1519f0b2fc1a15334d027df4))

- **cleanup**: Remove archived des-us003 feature folder
  ([`e0caa24`](https://github.com/nWave-ai/nwave-dev/commit/e0caa2497739c9978c1e0ddc63f2916f48422299))

- **cleanup**: Remove archived des-us004 feature folder
  ([`966f690`](https://github.com/nWave-ai/nwave-dev/commit/966f6901581ea978a13b8272bd97fd45f617de9f))

- **cleanup**: Remove duplicate turn-discipline folder
  ([`2292c2a`](https://github.com/nWave-ai/nwave-dev/commit/2292c2a06df734056174b3af1c760203cf0894cf))

- **des-hook-enforcement**: Clean up workflow artifacts after finalization
  ([`14ff17e`](https://github.com/nWave-ai/nwave-dev/commit/14ff17e2155d03711e4745176ac26b461a74e635))

- **des-us004**: Add commit hash to step 06-01
  ([`9c5d984`](https://github.com/nWave-ai/nwave-dev/commit/9c5d984d9355e0fa1ea6e48d4569ee99eec734d5))

- **des-us004**: Add commit hash to step 09-02
  ([`3ea50ed`](https://github.com/nWave-ai/nwave-dev/commit/3ea50edb41a5b81ecfdd66d1df9924c669a60f8d))

- **des-us004**: Complete step 03-02 tracking - TimeoutMonitor implementation
  ([`787e8d1`](https://github.com/nWave-ai/nwave-dev/commit/787e8d15edac5f8260429df550e6578a1567ccd1))

- **des-us004**: Update step 05-01 to DONE status
  ([`da1447b`](https://github.com/nWave-ai/nwave-dev/commit/da1447b650d3a6eedb24846e7d21c22a5dba93e7))

- **des-us004**: Update step 05-03 tracking (GREEN_ACCEPTANCE)
  ([`e18ae52`](https://github.com/nWave-ai/nwave-dev/commit/e18ae52f1f8edbc207ec793dfecbdeeab3658f81))

- **des-us005**: Clean up workflow artifacts after finalization
  ([`2f9525b`](https://github.com/nWave-ai/nwave-dev/commit/2f9525b360fa79444df33728be9cdb4d51bad133))

- **des-us006**: Clean up finalized feature artifacts
  ([`37fee6f`](https://github.com/nWave-ai/nwave-dev/commit/37fee6feb6f05400621b18ff664d2c988529c792))

- **des-us006**: Complete step 01-03 phase tracking
  ([`f7c9fd5`](https://github.com/nWave-ai/nwave-dev/commit/f7c9fd5f8fab387e17c9f575c06b2442e7602d29))

- **des-us006**: Complete step 05-02 phase tracking
  ([`85a33d7`](https://github.com/nWave-ai/nwave-dev/commit/85a33d7966bdf18fcf96d55a4788de204dc26e6f))

- **des-us006**: Finalize step 05-04 - update quality gates and completion status
  ([`4782fc1`](https://github.com/nWave-ai/nwave-dev/commit/4782fc1b9aa5b4f8757439d4f59f028c2b707521))

- **des-us006**: Mark step 02-04 as COMPLETED with all 8 phases
  ([`271239f`](https://github.com/nWave-ai/nwave-dev/commit/271239ffcafbcecba97f48bea45102ba532fcc2d))

- **des-us006**: Mark step 04-02 complete with all 8 phases executed
  ([`d6f1021`](https://github.com/nWave-ai/nwave-dev/commit/d6f10219f800a62b3f38ec1dcdf62140eef8cde7))

- **des-us006**: Update audit log for finalization workflow
  ([`cafb05d`](https://github.com/nWave-ai/nwave-dev/commit/cafb05d01574cbb74e5740127b1203e20129b9b1))

- **des-us006**: Update step 01-04 with COMPLETED status
  ([`7465f4a`](https://github.com/nWave-ai/nwave-dev/commit/7465f4ae5afe10ed698cfc6aa2c4665055520200))

- **des-us006**: Update step 02-02 with COMPLETED status
  ([`57d5d9d`](https://github.com/nWave-ai/nwave-dev/commit/57d5d9dcebe9e4fa6a2b9848fc75d347d75c4be0))

- **des-us006**: Update step 05-01 to COMPLETED status
  ([`731dad3`](https://github.com/nWave-ai/nwave-dev/commit/731dad326a1289cd6e72ec6d09cd069cec729056))

- **des-us006**: Update step 05-03 to COMPLETED status
  ([`737bb5a`](https://github.com/nWave-ai/nwave-dev/commit/737bb5ad0088f903e2d3dba79da06260b3b9575a))

- **des-us007**: Archive workflow files and clean mutation artifacts
  ([`bfd75c4`](https://github.com/nWave-ai/nwave-dev/commit/bfd75c4edefb8bd636e3b89896196717e2c6fcc5))

- **des-us007**: Complete step 01-02 - verify BOUNDARY_RULES structure
  ([`1130586`](https://github.com/nWave-ai/nwave-dev/commit/113058646d11d24cef90851da93486c1b7923f80))

- **des-us007**: Phase 4 - Archive old architecture (Schema v2.0 migration complete)
  ([`72f924c`](https://github.com/nWave-ai/nwave-dev/commit/72f924cdaa148b2f6b80c238b353241f7d3250e1))

- **des-us007**: Update execution status for step 01-01 completion
  ([`1e87006`](https://github.com/nWave-ai/nwave-dev/commit/1e870061dc88560dcc39e4faa9a0706554d3c310))

- **des-us007**: Update execution status for step 01-02 completion
  ([`3cfbcc5`](https://github.com/nWave-ai/nwave-dev/commit/3cfbcc534d6ae8d3bc3f4d2db38e6ba56931faaa))

- **des-us007**: Update execution status for step 01-03 completion
  ([`62025b3`](https://github.com/nWave-ai/nwave-dev/commit/62025b3e13daef2e7a8bafa6f7d40982a443bc5d))

- **des-us007**: Update execution status for step 02-01 completion
  ([`b5ea81b`](https://github.com/nWave-ai/nwave-dev/commit/b5ea81b1bc3cedebf832494e54b170adc59b24d2))

- **des-us007**: Update execution status for step 02-03 completion
  ([`0b59536`](https://github.com/nWave-ai/nwave-dev/commit/0b5953636d239485679508c92176e309c82abb99))

- **des-us007**: Update execution status for step 02-04 completion
  ([`0d11e5e`](https://github.com/nWave-ai/nwave-dev/commit/0d11e5e74eb69d7da3d9f4cf99cd60eac3521301))

- **des-us007**: Update execution status for step 03-01 completion
  ([`c6342ae`](https://github.com/nWave-ai/nwave-dev/commit/c6342ae4c73bfe1c08864f9be0839c6d9b6af049))

- **des-us007**: Update execution status for step 03-02 completion
  ([`f26d23c`](https://github.com/nWave-ai/nwave-dev/commit/f26d23c7b8e35b72e08add0b7f5e2ba492e48c06))

- **des-us007**: Update execution status for step 03-04 completion
  ([`e5f2ce9`](https://github.com/nWave-ai/nwave-dev/commit/e5f2ce96bb8fd7bc942cc36b76009faf5b6f5ae6))

- **des-us007**: Update execution status for step 04-01 completion
  ([`24e2caf`](https://github.com/nWave-ai/nwave-dev/commit/24e2caf38fa8eceaf74882620efa030fa8ee0b76))

- **des-us007**: Update execution status for step 04-02 completion
  ([`c4c5a22`](https://github.com/nWave-ai/nwave-dev/commit/c4c5a228d5651169d729f495c2f3af05ed3437b8))

- **des-us007**: Update execution status for step 04-04 completion
  ([`8667520`](https://github.com/nWave-ai/nwave-dev/commit/8667520f0965cfe7357bec96bc35e799d6d4258f))

- **develop**: Update step files and test artifacts (checkpoint)
  ([`2f098b1`](https://github.com/nWave-ai/nwave-dev/commit/2f098b10b363d9803fff7f02b2522dd13379bc4b))

- **execution-status**: Update statistics for completed step 04-05
  ([`4e4ebf7`](https://github.com/nWave-ai/nwave-dev/commit/4e4ebf7a818618445722a1838429cb289b91a81d))

- **finalize**: Complete des-hook-enforcement feature with evolution document
  ([`b54edf2`](https://github.com/nWave-ai/nwave-dev/commit/b54edf26e3c2c552fb6e068c4665b4d5eeea8937))

- **finalize**: Complete plugin-architecture feature cleanup
  ([`da9dca9`](https://github.com/nWave-ai/nwave-dev/commit/da9dca9d23f4a567be5f43941c269777cc71d554))

- **hooks**: Remove dead shell-syntax-check hook
  ([`76be9c4`](https://github.com/nWave-ai/nwave-dev/commit/76be9c4e864c0d42823775e84f0b10a299b9bb01))

- **plugin-architecture**: Update execution-status for step 03-02 completion
  ([`04d75b2`](https://github.com/nWave-ai/nwave-dev/commit/04d75b24cd55ea44150647f85ab21199bd35554b))

- **plugin-architecture**: Version bump to 1.7.0 (step 05-01)
  ([`48d38fc`](https://github.com/nWave-ai/nwave-dev/commit/48d38fc995a49550980136d0691a6fe8eb3fca27))

- **recovery-suggestion-formatting**: Clean up workflow artifacts after finalization
  ([`f543505`](https://github.com/nWave-ai/nwave-dev/commit/f543505439c24b301a5e4ffa88d64fd39112a256))

- **version**: Bump to 1.2.85 - Schema v2.0 with 8-phase TDD
  ([`71a6cdd`](https://github.com/nWave-ai/nwave-dev/commit/71a6cddfe30fd62ff9b3cf6eaf5483803e7bde95))

### Code Style

- Apply ruff format across codebase
  ([`04a0788`](https://github.com/nWave-ai/nwave-dev/commit/04a0788910deb236461188bf10bbfec97840c501))

- Apply ruff formatting
  ([`051b481`](https://github.com/nWave-ai/nwave-dev/commit/051b481e6841dbff4864208e06f30edef86258eb))

- Apply ruff formatting to DES test files
  ([`f920668`](https://github.com/nWave-ai/nwave-dev/commit/f920668265bddab12a3f3eb6163ff44992360e5c))

- Apply ruff formatting to sync_doc_versions.py
  ([`61c1752`](https://github.com/nWave-ai/nwave-dev/commit/61c17525e5ea6db6b76f1a0f0314ba1107c93309))

- Apply ruff formatting to test files
  ([`24044bc`](https://github.com/nWave-ai/nwave-dev/commit/24044bc17f15b308772924d3ca3ecd6c66d91e06))

- Apply ruff formatting to us007 tests
  ([`9bf8471`](https://github.com/nWave-ai/nwave-dev/commit/9bf84713783fb07fada98bb98bde79bc016bf001))

- Remove unnecessary f-strings in test_des_plugin.py
  ([`4d6971c`](https://github.com/nWave-ai/nwave-dev/commit/4d6971ccdb81c528da1c92ee0608edb8bf2c11ea))

- **ci**: Add emojis to all job and step names for readable GitHub Actions UI
  ([`a0e6797`](https://github.com/nWave-ai/nwave-dev/commit/a0e6797f3edeffe203904e879cf936f6e25a54f0))

- **des-plugin**: Tui emoji format for __pycache__ cleanup message
  ([`257016e`](https://github.com/nWave-ai/nwave-dev/commit/257016e7d6e7148f240c45af7759008b80d8df09))

- **install-utils**: Tui emoji for confirm_action cancel
  ([`11c7f26`](https://github.com/nWave-ai/nwave-dev/commit/11c7f267fbc41794f64295d59a810133f7ef67e6))

- **installer**: Add indentation to validation checks for visual hierarchy
  ([`003bfa5`](https://github.com/nWave-ai/nwave-dev/commit/003bfa5c1ab743ead1103ef39556aa0dd8ac4f44))

- **installer**: Add 🚨 emoji to all DRY RUN tags and TUI format DES + utilities plugins
  ([`8eafabc`](https://github.com/nWave-ai/nwave-dev/commit/8eafabc6acd84971358dc122a2a7bd73df08232e))

- **installer**: Replace plugin messages with TUI emoji format
  ([`764126a`](https://github.com/nWave-ai/nwave-dev/commit/764126ac24edfee9fd6b642ad0c12eb1c3247c7b))

- **installer**: Tui emoji format for installer, registry, and all plugins
  ([`d7afc63`](https://github.com/nWave-ai/nwave-dev/commit/d7afc63c749cfca97933b0ea1dc668c1e301d1b0))

- **installer**: Tui validation, quick start panel, rebrand URLs to nWave-ai/nWave
  ([`a2687e2`](https://github.com/nWave-ai/nwave-dev/commit/a2687e29beabe3bf2c14f309f7f0cfec5ac1feed))

- **installer**: Unify spinner messages to generic work in progress
  ([`93db924`](https://github.com/nWave-ai/nwave-dev/commit/93db924415a46bf7f91464426b43386a8af85b4b))

- **tests**: Apply ruff formatting to step definitions
  ([`3e6af71`](https://github.com/nWave-ai/nwave-dev/commit/3e6af711953464fe5f008622dd0629f7f8f4905d))

- **tests**: Apply ruff formatting to US-007 step definitions
  ([`ee54704`](https://github.com/nWave-ai/nwave-dev/commit/ee547043d150cdacac7a48f969b2f45222224b75))

- **tests**: Fix ruff formatting and remove cached files
  ([`89a0c33`](https://github.com/nWave-ai/nwave-dev/commit/89a0c33514ccfb58d09f87de8d298b494a7c23f3))

- **tests**: Remove unused pytest import from backup cleanup tests
  ([`a2a2d5d`](https://github.com/nWave-ai/nwave-dev/commit/a2a2d5d8040cd765cb671e6f20f4d6c6ecf7d625))

- **uninstaller**: Unified Logger TUI emoji format
  ([`af2a66c`](https://github.com/nWave-ai/nwave-dev/commit/af2a66ce7c6e182739cf63da4e588bddb5a77a4e))

- **update**: Apply ruff formatting to backup_manager
  ([`4c6eb84`](https://github.com/nWave-ai/nwave-dev/commit/4c6eb842663ba60cbb2c175c8131fd80fc32b11b))

- **verifier**: Add shared logo to terminal output
  ([`a6b52f2`](https://github.com/nWave-ai/nwave-dev/commit/a6b52f2fd38b435d6b5c81820156c9afc4224fcc))

- **verifier**: Tui emoji format, kill ansi constants
  ([`9ae555f`](https://github.com/nWave-ai/nwave-dev/commit/9ae555fb02ec068db1be120bd2d971f3a1557d13))

### Continuous Integration

- Add version consistency gate to Stage 2 framework validation
  ([`ff5834b`](https://github.com/nWave-ai/nwave-dev/commit/ff5834b5c2c9f565ac29d4f306a3ee0a17fa0d3f))

- Disable testpypi workflow pending distribution strategy rethink
  ([`4ccdba5`](https://github.com/nWave-ai/nwave-dev/commit/4ccdba50434450e08b3856958ead7722a3562535))

- Fix ruff lint, gitlint body length, and build wheel python version
  ([`2d1db48`](https://github.com/nWave-ai/nwave-dev/commit/2d1db483d3cedc60e09163942b29f83ae620e466))

- Fix test environment dependency and coverage config
  ([`14c22b7`](https://github.com/nWave-ai/nwave-dev/commit/14c22b70eab4ed87d5fdeabc8199719e9377a998))

- Ignore gitlint T5 rule (WIP in title)
  ([`05819ef`](https://github.com/nWave-ai/nwave-dev/commit/05819ef81d558b13fdab0e63355406ccd906d44c))

- Remove obsolete version-sync-check workflow
  ([`1e367a5`](https://github.com/nWave-ai/nwave-dev/commit/1e367a5da9ae2f80422d9803017c1164d337f28a))

- Remove temporary installer branch from push triggers
  ([`b5dc4e5`](https://github.com/nWave-ai/nwave-dev/commit/b5dc4e539997d6545455067bc9fa9e5bd1af6b83))

- Remove testpypi and wip release workflows
  ([`2dc607f`](https://github.com/nWave-ai/nwave-dev/commit/2dc607fbce2a2249abd6f652a6eea58d7559a76f))

- Semantic release changelog from conventional commits
  ([`346bea3`](https://github.com/nWave-ai/nwave-dev/commit/346bea308b8c3eb31acac9020d335618eba9e678))

### Documentation

- Add build pipeline documentation and fix path references
  ([`326f5f9`](https://github.com/nWave-ai/nwave-dev/commit/326f5f9e7a200cdfb42460662349d174be75a8f2))

- Add build pipeline documentation and fix path references
  ([`715367f`](https://github.com/nWave-ai/nwave-dev/commit/715367fbffe6098dadedb113d51145d22be24835))

- Add comprehensive progressive refactoring summary (L1-L4)
  ([`7b0ba98`](https://github.com/nWave-ai/nwave-dev/commit/7b0ba982b8f6883d36f3d6ed0c688db3c6a1ed18))

- Add parking lot and backlog items from DEVELOP wave
  ([`844efd3`](https://github.com/nWave-ai/nwave-dev/commit/844efd30fb81acf45debd16fc9fc3d08685898fa))

- Add step-to-scenario mapping documentation
  ([`9f6c48c`](https://github.com/nWave-ai/nwave-dev/commit/9f6c48c63d0a5a51c1ad13f32bb8dc3e13e61a3e))

- Add step-to-scenario mapping documentation
  ([`1ad0d87`](https://github.com/nWave-ai/nwave-dev/commit/1ad0d8714685830a9f196a8c8c7037359f34c3d0))

- Add WIP + /nw:develop integration report for future WIP branch
  ([`22dcb8f`](https://github.com/nWave-ai/nwave-dev/commit/22dcb8f39a9a579ac856b7702e131b8e131f7ff1))

- Enforce single-source versioning and update 5-layer framework terminology
  ([`2a77078`](https://github.com/nWave-ai/nwave-dev/commit/2a770786944bae98f7d47d80e733426ecaac379e))

- Update commit_hash in step 05-04 contract file
  ([`5ae16a8`](https://github.com/nWave-ai/nwave-dev/commit/5ae16a83cc91bae8b6f5da036ccc8189a1bdbd00))

- **01-02**: Update execution status - step complete
  ([`ac4cd66`](https://github.com/nWave-ai/nwave-dev/commit/ac4cd66292b2806706316e4d62677ab7bb18edff))

- **02-02**: Update execution status with step completion
  ([`b9bb89d`](https://github.com/nWave-ai/nwave-dev/commit/b9bb89d627d665b9422a5e4cba44ffb8160f515c))

- **02-03**: Update step file with completed TDD cycle
  ([`7ebc426`](https://github.com/nWave-ai/nwave-dev/commit/7ebc4267dc1646996debce8ea05d04a3bda0a65e))

- **architecture**: Update plugin docs status to IMPLEMENTED
  ([`6b7a412`](https://github.com/nWave-ai/nwave-dev/commit/6b7a412b68c1e6d99653db5ac577bddee25d2eb4))

- **audit-log**: Complete step 01-02 with COMMIT and FILES_MODIFIED events
  ([`7e6e8a3`](https://github.com/nWave-ai/nwave-dev/commit/7e6e8a3b49d5d73ba04520e495682f8074b90688))

- **audit-log**: Mark step 01-01 as completed in execution log
  ([`cfa1480`](https://github.com/nWave-ai/nwave-dev/commit/cfa148012ed874b39a88d774df18056374197cb8))

- **checkpoint**: Add commit/push phase to finalize.md
  ([`d5d7943`](https://github.com/nWave-ai/nwave-dev/commit/d5d7943b4c8463da79a0cde16cdf25d373a3b626))

- **checkpoint**: Add commit/push phase to finalize.md
  ([`eac4911`](https://github.com/nWave-ai/nwave-dev/commit/eac4911a77ac55855739d2539e964e9bfdb011a4))

- **checkpoint**: Add post-finalize commit/push to develop.md
  ([`242e945`](https://github.com/nWave-ai/nwave-dev/commit/242e94565b13cd80a86dc576ddc766db49964d08))

- **checkpoint**: Add post-finalize commit/push to develop.md
  ([`cb97122`](https://github.com/nWave-ai/nwave-dev/commit/cb9712290ea9c4332a0cec0f83b62cb26a17032f))

- **checkpoint**: Add TDD checkpoint commit strategy to execute.md
  ([`247be2a`](https://github.com/nWave-ai/nwave-dev/commit/247be2a7830d9ad760f78629194bf1ac059d93ee))

- **checkpoint**: Add TDD checkpoint commit strategy to execute.md
  ([`9cccbf0`](https://github.com/nWave-ai/nwave-dev/commit/9cccbf0a9eaa85869be61c801c589923630f70ab))

- **checkpoint**: Document CHECKPOINT_PENDING in schema.json
  ([`eb27df8`](https://github.com/nWave-ai/nwave-dev/commit/eb27df816a43662908a7d4f579a6e4df26cb7f91))

- **checkpoint**: Document CHECKPOINT_PENDING in schema.json
  ([`9786acb`](https://github.com/nWave-ai/nwave-dev/commit/9786acbc9c89a0b24455616bcf66bac2d089b924))

- **des**: Add final verification review v1.6.0 - APPROVED 100%
  ([`75049d9`](https://github.com/nWave-ai/nwave-dev/commit/75049d95132ed8da888b4ed16d59a6d96cef2c1f))

- **des**: Add software-crafter-reviewer implementation feasibility review
  ([`393c3ed`](https://github.com/nWave-ai/nwave-dev/commit/393c3ed8e6ea7eefbbf4cb9eaaade207e92b8445))

- **des**: Add solution-architect-reviewer approval for architecture v1.5.0
  ([`95f4990`](https://github.com/nWave-ai/nwave-dev/commit/95f4990c9a21cb1cdb91375076501241b9b572f7))

- **des**: Document execution-log.yaml usage patterns per command
  ([`4cd17f3`](https://github.com/nWave-ai/nwave-dev/commit/4cd17f302b5546d571347d86f6855898d3497178))

- **des**: Finalize and archive DES hook redesign legacy cleanup
  ([`07bd4d3`](https://github.com/nWave-ai/nwave-dev/commit/07bd4d3a0bebe339a096b938bfc999ec09d4ec04))

- **des-hook-enforcement**: Add retrospective analysis to evolution document
  ([`748f389`](https://github.com/nWave-ai/nwave-dev/commit/748f38902dde5644fcede648c321a7ee46769fdf))

- **des-hook-enforcement**: Mark step 01-01 complete
  ([`7824559`](https://github.com/nWave-ai/nwave-dev/commit/7824559c1647c6613fbdf0159c3ea6fbcaec899c))

- **des-us003**: Document step 01-08 completion - SubagentStopHook wired into DESOrchestrator
  ([`9af3727`](https://github.com/nWave-ai/nwave-dev/commit/9af3727d81a44322507f25cfaaf6c44f94cf681a))

- **des-us004**: Complete step 02-02 tracking - turn limit enforcement in SubagentStopHook
  ([`3b6278a`](https://github.com/nWave-ai/nwave-dev/commit/3b6278afdaf76c394e1608d01b5e7f0e968414e6))

- **des-us004**: Document turn discipline and timeout features in DES design
  ([`e786da4`](https://github.com/nWave-ai/nwave-dev/commit/e786da4987c51486b38ef76c23418cb30e2fdde6))

- **des-us004**: Mark step 01-03 as COMPLETED
  ([`04004e1`](https://github.com/nWave-ai/nwave-dev/commit/04004e1f502665f97fb86119a260e9ae058f509d))

- **des-us004**: Mark step 03-03 as DONE
  ([`8b29abd`](https://github.com/nWave-ai/nwave-dev/commit/8b29abdc81a41919d5dd199c668d8772ec5131ec))

- **des-us004**: Update step 01-02 with commit hash
  ([`ed7a0ab`](https://github.com/nWave-ai/nwave-dev/commit/ed7a0ab32c7c519b03bb2591749703e01340ab95))

- **des-us004**: Update step 03-02 with COMMIT phase completion
  ([`d54c631`](https://github.com/nWave-ai/nwave-dev/commit/d54c631a856edcdefcd9e76407afbb6325a8e905))

- **des-us005**: Add external validity verification report for step 03-04 orchestrator integration
  ([`4cf5984`](https://github.com/nWave-ai/nwave-dev/commit/4cf5984ff2107966723066c7218fb9d2873906eb))

- **des-us005**: Archive User Story evolution document
  ([`2404427`](https://github.com/nWave-ai/nwave-dev/commit/2404427a8b74074e56eb8f3e86609e3750e9806c))

- **des-us005**: Re-finalize with orchestrator integration complete - PRODUCTION READY
  ([`86bac0c`](https://github.com/nWave-ai/nwave-dev/commit/86bac0c6e6fb31038a37a83f799ca34d9358a971))

- **des-us006**: Add traceability mapping to US-006 acceptance criteria
  ([`807421e`](https://github.com/nWave-ai/nwave-dev/commit/807421e75493df665c05aff0b37cee9ff11fac75))

- **des-us006**: Complete step 03-02 - update phase tracking to COMPLETED
  ([`c7fa080`](https://github.com/nWave-ai/nwave-dev/commit/c7fa080643b7735e674b8cc059c537921d61b03c))

- **des-us006**: Complete step 05-04 - Production readiness checklist and sign-off
  ([`099a24a`](https://github.com/nWave-ai/nwave-dev/commit/099a24aa80e02bbff30e3ffdba6adf2af9368d9c))

- **des-us006**: Document TIMEOUT_INSTRUCTION section specification in section 4.3
  ([`270fc0c`](https://github.com/nWave-ai/nwave-dev/commit/270fc0cf881fdde999afe304e81061ee6a49d685))

- **des-us006**: Finalize feature - archive workflow, create evolution document
  ([`d9d1b94`](https://github.com/nWave-ai/nwave-dev/commit/d9d1b94b9e2c5f53deefbfa7d338181eff35c604))

- **des-us006**: Verify complete TIMEOUT_INSTRUCTION structure passes validation - step 03-02
  ([`efd36c5`](https://github.com/nWave-ai/nwave-dev/commit/efd36c5924939a4450c91674582556d84ea755d1))

- **des-us006-02-00**: Complete step file with 8-phase TDD cycle tracking
  ([`42cc1f4`](https://github.com/nWave-ai/nwave-dev/commit/42cc1f4100f0beda340d878ae77f06fbe1faf222))

- **des-us006-03-03**: Validate end-to-end wiring - feature already implemented
  ([`32d416b`](https://github.com/nWave-ai/nwave-dev/commit/32d416b44d8584eb87fa1f992748ff8c91bb17c6))

- **des-us007**: Finalize evolution document with mutation testing results
  ([`074050e`](https://github.com/nWave-ai/nwave-dev/commit/074050eab3b3c1da31f49ad3470b6ab1ff852be0))

- **des-us008**: Complete DEVELOP wave with evolution document
  ([`d701dca`](https://github.com/nWave-ai/nwave-dev/commit/d701dca28a550cefde670915f5d485663ba9a275))

- **des-us008**: Complete step 04-02 execution tracking
  ([`f94c8df`](https://github.com/nWave-ai/nwave-dev/commit/f94c8df73c21ff4e76ec37dacc75ee9f67268e6a))

- **develop**: Complete Phase 05 - Cross-Cutting Concerns
  ([`231800e`](https://github.com/nWave-ai/nwave-dev/commit/231800e74889a17f093acb2cf505815f1f04fa60))

- **develop**: Complete Phase 06 - DEVELOP wave finished
  ([`5bbdd33`](https://github.com/nWave-ai/nwave-dev/commit/5bbdd3308b3ad66ba4250a2d114b23ee915392fa))

- **evolution**: Archive US-004 (Audit Trail) completion summary
  ([`21f3ced`](https://github.com/nWave-ai/nwave-dev/commit/21f3ced33de3e310fb434db2c6ece591cedb36ba))

- **evolution**: Archive versioning-release-management feature completion
  ([`8db1522`](https://github.com/nWave-ai/nwave-dev/commit/8db1522a14e4d19f00247bd32ae4b601e6d63878))

- **hook-context-injection**: Add retrospective with 5 Whys root cause analysis
  ([`315174b`](https://github.com/nWave-ai/nwave-dev/commit/315174ba00156969e004258ed4c9a414f211de5e))

- **hook-context-injection**: Create evolution document
  ([`f207b45`](https://github.com/nWave-ai/nwave-dev/commit/f207b45fb8a2ac0708d122d17dbcbfab72b96ea2))

- **level-4**: Document audit logger singleton as technical debt
  ([`4a929e9`](https://github.com/nWave-ai/nwave-dev/commit/4a929e9becdda5668d58022ad0fb0d84d896f3bc))

- **modern-cli-installer**: Complete phase 03 - journey 2 install local candidate
  ([`b8a53d6`](https://github.com/nWave-ai/nwave-dev/commit/b8a53d6bd7839805a557d906aa00852cffed590b))

- **modern-cli-installer**: Update tracking for step 03-01 completion
  ([`e83a3e5`](https://github.com/nWave-ai/nwave-dev/commit/e83a3e5657fdc83594234a3faa9899509e25993d))

- **nwave**: Refine distill command with test directory structure
  ([`c652f6a`](https://github.com/nWave-ai/nwave-dev/commit/c652f6a867aedf4107007ae34ae0d3e72a75f97f))

- **plugin-arch**: Resolve HIGH severity design review issues
  ([`9a45f7e`](https://github.com/nWave-ai/nwave-dev/commit/9a45f7ee5b14229ba935732227b6b317c749de25))

- **plugin-architecture**: Add DIVIO reference documentation
  ([`cb7ab9d`](https://github.com/nWave-ai/nwave-dev/commit/cb7ab9d29d253d8e2876307211e263ff17a2a4dd))

- **plugin-architecture**: Add retrospective to evolution document
  ([`2443a93`](https://github.com/nWave-ai/nwave-dev/commit/2443a93b2292b880de6a9f4a1a9a06bcad65e523))

- **plugin-architecture**: Design refinement by solution-architect
  ([`36b8021`](https://github.com/nWave-ai/nwave-dev/commit/36b8021daec10581ae14aa65b178ec19cc46e6dd))

- **plugin-architecture**: Distill wave acceptance tests
  ([`735806e`](https://github.com/nWave-ai/nwave-dev/commit/735806e59e6728b0d42c64815f6e09305fd63aae))

- **plugin-architecture**: Journey design and doc alignment
  ([`8fc26ad`](https://github.com/nWave-ai/nwave-dev/commit/8fc26ad1e880fe7160098a8c577a3c57bd6f2364))

- **recovery-suggestion-formatting**: Finalize US005 Phase 3 - Archive evolution document
  ([`50ef883`](https://github.com/nWave-ai/nwave-dev/commit/50ef883ec00a0ce4f0f8ea8c91f5bc49d21fc845))

- **recovery-suggestion-formatting**: Phase 3 evolution document - DEVELOP wave complete
  ([`79fea92`](https://github.com/nWave-ai/nwave-dev/commit/79fea92fb2cb8beddfb8c6e1d5457c392fbdbb60))

- **refactoring**: Add comprehensive test refactoring documentation (Phases 1-5)
  ([`ccd4d03`](https://github.com/nWave-ai/nwave-dev/commit/ccd4d030a8ec9d4076f9be189999bdabce3a419e))

- **requirements**: Add versioning and release management feature spec
  ([`7c0e651`](https://github.com/nWave-ai/nwave-dev/commit/7c0e651b01dded784509c279cf442d98a2b6917f))

- **research**: Add semantic-release best practices research
  ([`a5cbaa1`](https://github.com/nWave-ai/nwave-dev/commit/a5cbaa15994534f80b40a36ec58600b1233047cb))

- **safety**: Add mandatory max_turns for Task tool invocations
  ([`3ab57f6`](https://github.com/nWave-ai/nwave-dev/commit/3ab57f6fcda6f5418c1ede5f11932c17f64947f3))

- **session**: Save session state checkpoint for 2026-01-25
  ([`62f09f0`](https://github.com/nWave-ai/nwave-dev/commit/62f09f0d02e52bf7c52c1813bc457b6330a44a2f))

- **tests**: Update tests/acceptance README to reflect DES test relocation
  ([`9ebbe66`](https://github.com/nWave-ai/nwave-dev/commit/9ebbe661cb261788100817edf9bdd0a80358b8e5))

- **us003-roadmap**: Peer review - REJECTED pending effort estimation fixes
  ([`aa0f036`](https://github.com/nWave-ai/nwave-dev/commit/aa0f03654eb9286bd2221bbefbdffe5d838308e8))

- **us005-03-02**: Update step file - mark all 8 TDD phases EXECUTED
  ([`55cd401`](https://github.com/nWave-ai/nwave-dev/commit/55cd401c008ba04fafea32933c40ad2321d544f4))

- **versioning**: Complete DEVELOP wave for versioning-release-management
  ([`37f41e9`](https://github.com/nWave-ai/nwave-dev/commit/37f41e957382b2058f3cb89e600073d6cb462275))
...
- Remove obsolete step file tests
  ([`2f47f52`](https://github.com/nWave-ai/nwave-dev/commit/2f47f52ff9eac34ec291241500e23b6eabd6d083))

- **ci-cd**: Remove temporary failing test - Slack notifications verified
  ([`06e7fd6`](https://github.com/nWave-ai/nwave-dev/commit/06e7fd69dd7df8760a02913142112c181d4132a1))

- **ci-cd**: Temporary failing test to verify Slack notifications
  ([`492675d`](https://github.com/nWave-ai/nwave-dev/commit/492675df0f83eccaca8e9533bddf1ed42bccc49f))

- **des**: Complete quality validation for step 04-03 - all gates pass
  ([`528f57a`](https://github.com/nWave-ai/nwave-dev/commit/528f57a5c8ae8ceb8abf9dabed787d4bc305bf71))

- **des**: Migrate to template-based fixtures, eliminate hardcoded phases
  ([`7caf384`](https://github.com/nWave-ai/nwave-dev/commit/7caf38424f77d6c75d7b905fd67813b4440ede1f))

- **des**: Validate comprehensive unit test suite for DESOrchestrator
  ([`c3812fe`](https://github.com/nWave-ai/nwave-dev/commit/c3812fea6f1092ed67931f7576e3d66084bd70be))

- **des-us004**: Add comprehensive edge case tests for ExtensionApprovalEngine
  ([`788e483`](https://github.com/nWave-ai/nwave-dev/commit/788e4830d785a92703e2b9e9b384f00ba8bbc5d3))

- **des-us006**: Add comprehensive unit tests for TimeoutInstructionTemplate helper methods
  ([`d7751ab`](https://github.com/nWave-ai/nwave-dev/commit/d7751abf0b3417b74507ad08406e13a53d1fac30))

- **des-us006**: Complete step 05-03 - Full DES test suite regression validation
  ([`154c1d7`](https://github.com/nWave-ai/nwave-dev/commit/154c1d775ace810216215973aed729f58427850c))

- **des-us006**: Validate /nw:develop includes TIMEOUT_INSTRUCTION - step 02-02
  ([`80459d9`](https://github.com/nWave-ai/nwave-dev/commit/80459d9860c53808ee988a7c07bb2cfb6a4d9f1a))

- **des-us007**: Kill 8 surviving mutants in ScopeValidator tests
  ([`5afaada`](https://github.com/nWave-ai/nwave-dev/commit/5afaadac76f80d78925a9723df6edb6d18a3aea1))

- **des-us008**: Enable acceptance test for clean path verification (step 04-02)
  ([`00e7be5`](https://github.com/nWave-ai/nwave-dev/commit/00e7be5282e128a4969a0f8c74cc74ebb99be81b))

- **des-us008**: Enable scenario 006 - verify ABANDONED phases not flagged as stale
  ([`933c906`](https://github.com/nWave-ai/nwave-dev/commit/933c9060c85201af02965a89f33e14a02ae9cafd))

- **des-us008**: Enable scenario 010 - multiple stale executions verified
  ([`1a44a2a`](https://github.com/nWave-ai/nwave-dev/commit/1a44a2ae4da0a5a7ac6462b4370760d65146231a))

- **des-us008**: Verify no persistent daemon after stale check completes
  ([`22c8bd1`](https://github.com/nWave-ai/nwave-dev/commit/22c8bd11ebd1cb73747bdb15094d812280d4f82d))

- **installer**: Add acceptance tests for manifest circular dependency bug
  ([`c0de92c`](https://github.com/nWave-ai/nwave-dev/commit/c0de92c26d6b927d7c2a79d29f1eabb0325c7ae6))

- **installer**: Walking skeleton acceptance tests for install/uninstall TUI
  ([`908508e`](https://github.com/nWave-ai/nwave-dev/commit/908508ef5d25a56744e16046c73cebb1ca5d089d))

- **plugin-architecture**: Add unit tests to achieve >80% coverage
  ([`6ce2756`](https://github.com/nWave-ai/nwave-dev/commit/6ce275665abc3ffb3063d56aeb177f9a22c8d616))

- **slack**: Trigger RED notification test
  ([`cccf6d4`](https://github.com/nWave-ai/nwave-dev/commit/cccf6d4b07c9ae9e9471c42283744096d0653f8d))

- **slack**: Trigger RED notification with state tracking
  ([`e4f460e`](https://github.com/nWave-ai/nwave-dev/commit/e4f460e6a438824be4febd6a3bc0958d28de7473))

- **template**: Add validation tests for template resolution
  ([`c816db7`](https://github.com/nWave-ai/nwave-dev/commit/c816db7245b1484a1b2ded4bb1ff5f9284051e83))

- **turn-count-01-04**: Complete turn counting unit tests with 100% coverage - All 14 TDD phases
  executed
  ([`3306d96`](https://github.com/nWave-ai/nwave-dev/commit/3306d961b0d6b54843c6a457dc6912dff16f2338))

- **us005-03-03**: Update step file with complete 8-phase TDD execution log
  ([`1963bf4`](https://github.com/nWave-ai/nwave-dev/commit/1963bf4df8528075ddac0ac2cb72b25a7fda160f))
...
- Add comprehensive unified CI/CD workflow
  ([`30aa817`](https://github.com/nWave-ai/nwave-dev/commit/30aa81762aff927640e15a5429c92f3df552ed02))
