...
| `nw-at-completeness-check-structural-invariants` | KNOWLEDGE | Auditing whether the AT set itself is STRUCTURALLY sound (Tier-2: S1 step-text uniqueness, S2 driving-port-only, S3 dormant-seam, S5 distinguishable outcomes, S6 installed-surface driving, S7 oracle reachability, S8 causal sensitivity; independent BLOCK). |
