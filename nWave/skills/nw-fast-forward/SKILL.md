...
**New project (description provided):** Derive feature ID per `~/.claude/skills/nw-wizard-shared-rules/SKILL.md` (Feature ID Derivation). Show derived ID, allow override via AskUserQuestion. Create `docs/feature/{feature-id}/`.
...
Check wave artifacts using Wave Detection Rules in `~/.claude/skills/nw-wizard-shared-rules/SKILL.md`.
