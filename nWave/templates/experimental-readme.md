...
File issues at [github.com/{target_slug}/issues](https://github.com/{target_slug}/issues) with a label `feedback` or `beta`. Include relevant entries from `.nwave/beta-feedback.md` (scrubbed for privacy). Or email directly with the log attached.
