#!/usr/bin/env python3
"""
nWave Framework Release Package Creator

Creates distributable packages for different IDE platforms from the nWave/ source directory.
Generates tarballs and installers that can be uploaded to GitHub releases.

Usage:
    python create_release_packages.py [--output-dir DIR] [--version VERSION]

Requirements:
    - nWave/ source directory with agents/ and tasks/nw/
    - Python 3.7+
...
class ReleasePackager:
    ...
    def validate_source(self) -> bool:
        ...
        if not agents_dir.exists() or not commands_dir.exists():
            self._log("Required directories not found in nWave/", "ERROR")
            return False
...
---
Generated by nWave Release Packager v{__version__}
"""
    ...
    def run(self) -> bool:
        ...
        self._log("=" * 60)
        self._log(f"nWave Framework Release Packager v{__version__}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create nWave Framework release packages",
