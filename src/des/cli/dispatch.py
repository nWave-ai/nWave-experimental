...
def _default_skill_loading_body(agent: str) -> str:
    ...
    return (
        ...
        "load -- this section only reminds you to obey it. Invoke "
        "Skill(<exact skill name>) at the role table's phase trigger, BEFORE "
        "any other work, and emit `[SKILL LOADED] {skill-name}` for each so "
        "the load is observable rather than asserted.\n"
