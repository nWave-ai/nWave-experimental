"""pytest-bdd binding for slice-01-verify-environmental-e2e-cli-t1.
...
from `common_steps`. No step definitions or business logic live here.
"""
...
scenarios("../slice-01-verify-environmental-e2e-cli-t1.feature")
