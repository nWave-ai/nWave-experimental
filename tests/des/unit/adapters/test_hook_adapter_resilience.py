...
class TestTaskStartTimeFromSignal:
    ...
    def test_task_start_time_read_from_signal(self, tmp_path: Path) -> None:
        """UT-17: _read_des_task_signal returns created_at from signal file."""
        from des.adapters.drivers.hooks.claude_code_hook_adapter import (
            DES_SESSION_DIR,
        ...
        signal_file = signal_dir / "des-task-active"
        signal_data = {
            "step_id": "01-03",
